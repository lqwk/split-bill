...
- (void)testPrint {
    ...
    SBExpense *expense = [SBExpense expenseWithPayments:[NSArray arrayWithObjects:payment, payment, payment, payment, nil] andPeople:[NSArray arrayWithObjects:person, person2, nil]];
